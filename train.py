...
def _main():
    ...
    if True:
        ...
        model.fit_generator(data_generator_wrapper(image_directory,lines[:num_train], batch_size, input_shape, anchors, num_classes),
...
def data_generator(image_folder,annotation_lines, batch_size, input_shape, anchors, num_classes):
    ...
    while True:
        ...
        for b in range(batch_size):
            ...
            image, box = get_random_data(image_folder+annotation_lines[i], input_shape, random=True)
...
def data_generator_wrapper(image_folder,annotation_lines, batch_size, input_shape, anchors, num_classes):
    n = len(annotation_lines)
    if n==0 or batch_size<=0: return None
    return data_generator(image_folder,annotation_lines, batch_size, input_shape, anchors, num_classes)
